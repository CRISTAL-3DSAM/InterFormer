...
def main():
    ...
    if opt.visual:
        ...
        for b in range(len(generated)):
            ...
            classes = ['walking','kicking','pushing','shaking_hands','exchanging','punching']
            lab = opt.Labels[b]
            idx = classes.index(lab)

            show_skeleton(reaction,action,GT,b,lab)
            show_skeleton_single(reaction,action,b,lab)
    print("DONE")
