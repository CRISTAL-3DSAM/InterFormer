...
class DeepGRU(nn.Module):
    ...
    def forward(self, x_padded, x_lengths):
        ...
        #
        scipy.io.savemat('sequences_lenghts', dict([('lengths', x_lengths.cpu().detach().numpy())]))
        ...
        scipy.io.savemat('features_Interformer', dict([('features', rer.data.cpu().detach().numpy())]))
